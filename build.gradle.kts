...
dependencies {
  ...
  implementation("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.22.3") // also needed runtime for AppInsights
  ...
  runtimeOnly("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.22.3") // needed for OffsetDateTime for AppInsights
  ...
  implementation("org.hibernate:hibernate-core:7.4.10.Final")
