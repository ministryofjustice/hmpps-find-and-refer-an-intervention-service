INSERT INTO intervention_catalogue (id, name, int_type, short_description, long_description, topic, session_detail, commencement_date,
                                    termination_date, created, created_by, last_modified, last_modified_by)
VALUES
    (
    ...
    (
      ...
      'The D&R service provides support to individuals within the community to address addictions. The service offers the following interventions and programmes:
                        - Relapse prevention
