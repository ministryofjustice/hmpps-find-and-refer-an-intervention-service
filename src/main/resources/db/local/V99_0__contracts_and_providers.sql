...
INSERT INTO contract_type (id,name,code) VALUES
	 ('72e60faf-b8e5-4699-9d7c-aef631cca71b','Accommodation','ACC'),
...
INSERT INTO contract_type (id,name,code) VALUES
	 ('f7569c39-5c3a-457e-9a29-435858af55e0','Finance, Benefit and Debt (South Central)','FBD-SC'),
...
INSERT INTO contract_type (id,name,code) VALUES
	 ('ee20282e-aea4-429e-8b3f-0d868c46e8bc','Finance, Benefit and Debt (Yorkshire and the Humber)','FBD-Y'),
...
INSERT INTO contract_type (id,name,code) VALUES
	 ('26239d61-b742-423a-842c-fab1950e17a2','Finance, Benefit and Debt (Bury)','FBD-BU'),
...
values ('98a42c61-c30f-4beb-8062-04033c376e2d', '1d7f8fcc-aa12-4705-a6a5-0d40467e03e9', TO_DATE('2020-10-15', 'YYYY-MM-DD'), 'Accommodation Service', 'The service aims are to support in securing settled accommodation.', 'contact@harmonyliving.com'),
       ...
       ('f803445f-326c-4ef8-aee2-f7716d417832', 'c7d39f92-6f43-49a4-bb62-e0f42c864765', TO_DATE('2020-11-11', 'YYYY-MM-DD'), 'Social Inclusion', 'This programme is aimed at males who have offended.• This programme is aimed at males who have offended.• This is some more text about the intervention', 'contact@hometrust.com'),
