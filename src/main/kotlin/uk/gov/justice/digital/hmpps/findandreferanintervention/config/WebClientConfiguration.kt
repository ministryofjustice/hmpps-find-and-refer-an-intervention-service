...
import uk.gov.justice.digital.hmpps.findandreferanintervention.client.RestClient
...
class WebClientConfiguration(
  ...
  @Bean
  fun findAndReferDeliusApiClient(authorizedClientManager: OAuth2AuthorizedClientManager): RestClient = RestClient(
